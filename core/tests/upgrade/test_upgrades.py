...
from trezorlib import btc, device, debuglink
...
# TODO move to root! or python respectivelly

CORE_BUILD = os.path.dirname(os.path.abspath(__file__)) + "/../../build/unix/micropython"
LEGACY_BUILD = os.path.dirname(os.path.abspath(__file__)) + "/../../../legacy/firmware/trezor.elf"
...
try_tags("core", ["v2.1.0"], CORE_BUILD)
